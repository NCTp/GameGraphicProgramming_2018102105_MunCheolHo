...
SamplerState smaplerDiffuse : register(s0);
...
float4 PSVoxel(PS_INPUT input) : SV_TARGET
{
    ...
    float3 ambient = float3(5.0f, 0.0f, 0.0f);
    float3 lightDirection = float3(5.0f, 0.0f, 0.0f);
    float3 diffuse = float3(5.0f, 0.0f, 0.0f);
